...
@Slf4j
@Component
public class TimeoutRefundTopicListener {
    ...
    @RabbitListener(queues = "${spring.rabbitmq.config.producer.delay_order_cancel.dlx_process_queue}")
            ...
            for (UserGroupBuyOrderDetailEntity orderDetail : timeoutOrderList) {
                try {
                    ...
                    TradeRefundCommandEntity refundCommand = TradeRefundCommandEntity.builder()
                            ...
                            .activityId(orderDetail.getActivityId())
