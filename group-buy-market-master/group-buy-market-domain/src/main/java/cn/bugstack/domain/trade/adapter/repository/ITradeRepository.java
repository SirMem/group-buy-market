...
public interface ITradeRepository {
    ...
    String reserveTotalStockTry(InventoryReservationEntity inventoryReservationEntity, int ttlMinutes);

    void confirmTotalStock(String outTradeNo);

    void cancelTotalStock(String outTradeNo, String goodsId);

    void setTotalStock(String goodsId);

    void updateTotalStockReserveCount(InventoryReservationEntity inventoryReservationEntity);

    void confirmSkuTotalStockDB(InventoryReservationEntity inventoryReservationEntity);

    void cancelTotalStockDB(InventoryReservationEntity inventoryReservationEntity);

    void refundTotalStockDB(InventoryReservationEntity inventoryReservationEntity);
